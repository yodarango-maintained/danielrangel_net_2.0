export const projects = [
  ...
  },
  {
    ...
    description: [
      "",
      "Savvy Saute is a fully customizable blog where. Private routes are protected by passport sessions. The architecture is MVC using EJS.",
      "The about page displays links to the admin's scoial site and a subscribtion form, all which is seen by the admin in the admin dashboard.",
      "The post section displays all posts created with a pagination of 10 posts per page. All data is stored using MongoDB.",
      "The CMS allows the admin to edit all text in every page of the blog, add social sites, chagne passowrd, CRUD content and subscribers.",
      "Users are allowed to submit puclic commentaries about the blog which are displayed at the bottom of the home page.",
    ],
